...
public class CadrastroDados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        origem = (EditText) findViewById(R.id.campo_cadrastrar_origem);
        destino = (EditText) findViewById(R.id.campo_cadrastrar_destino);
        valor = (EditText) findViewById(R.id.campo_cadrastrar_valor);
    ...
    public void AtualizarDados() {
        ...
        Intent intent = getIntent();
        try {
            DADOSID = (Integer) intent.getSerializableExtra("IDDados");
        } catch (Exception e) {
            DADOSID = null;
        }
        if (!(DADOSID == null)) {
            ...
            Dados dados = BF.BuscarAtualizarDados(DADOSID);
            origem.setText(dados.getOrigem());
            destino.setText(dados.getDestino());
            valor.setText(dados.getValor().toString());
            Id = dados.getId();
        }
    }
